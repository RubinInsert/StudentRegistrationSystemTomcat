 ...
 * Generated at: 2025-04-04 04:38:48 UTC
...
public final class course_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for (Course course : courses) { 
      ...
      out.write(", \"isFull\":");
      out.print(courseService.isCourseFull(course));
      out.write(", \"assumedKnowledge\":\"");
      out.print(courseService.hasStudentPassedAssumedKnowledge(studentID, course.getCourseID()));
      out.write("\", \"preKnowledge\":\"");
      out.print(courseService.hasStudentPassedPreReqKnowledge(studentID, course.getCourseID()));
      out.write("\"}' value=\"");
      out.print( course.getCourseID() );
      out.write("\"></option>\r\n");
      out.write("                    ");
      ...
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if(course.isFull) {\r\n");
      out.write("                alert('Course is full. Please select another course.');\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if(course.preKnowledge != \"null\") {\r\n");
      out.write("                alert('WARNING: You have not passed the pre-req knowledge for this course. You must first complete: ' + course.preKnowledge + ' before enrolling in this course.');\r\n");
      out.write("                return;\r\n");
      out.write("            } else if(course.assumedKnowledge != \"null\") {\r\n");
      out.write("                alert('WARNING: You have not passed the assumed knowledge for this course. It is recomended that you complete: ' + course.assumedKnowledge + ' before enrolling in this course.');\r\n");
      out.write("            }\r\n");
      ...
      out.write("            document.getElementById('selectedCourses').value = selectedCoursesArray.join(','); // Add to hidden element\r\n");
      out.write("            document.getElementById('courseCode').value = ''; // Clear input field\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("            var removeButtonLocation = row.insertCell(4);\r\n");
      out.write("            var removeButton = document.createElement('button');\r\n");
      out.write("            removeButton.innerHTML = 'Remove';\r\n");
      out.write("            removeButtonLocation.appendChild(removeButton);\r\n");
      out.write("\r\n");
      out.write("            removeButton.onclick = function() {\r\n");
      out.write("                table.deleteRow(row.rowIndex);\r\n");
      out.write("                chosenCourseUnits -= course.units; // Subtract the units of the removed course\r\n");
      out.write("\r\n");
      out.write("    // Remove the course from the hidden input field\r\n");
      out.write("    var selectedCourses = document.getElementById('selectedCourses').value;\r\n");
      out.write("    var selectedCoursesArray = selectedCourses.length > 0 ? selectedCourses.split(',') : []; // Make string into array, or an empty array\r\n");
      out.write("    selectedCoursesArray = selectedCoursesArray.filter(id => id !== course.ID); // Remove the element in array which matches the course ID\r\n");
      out.write("    document.getElementById('selectedCourses').value = selectedCoursesArray.join(','); // Put new array back into place.\r\n");
      out.write("            }\r\n");
      out.write("            } else {\r\n");
